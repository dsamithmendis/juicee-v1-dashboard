            ...
            <tbody>
              {cards.map((card) => (
                <tr key={card._id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-gray-800 font-medium">{card.title}</td>
                  <td className="px-6 py-4 text-gray-600">{card.description}</td>
                  <td className="px-6 py-4 text-gray-700 font-medium">{card.category}</td>
                  <td className="px-6 py-4 text-orange-600 font-bold">LKR {card.price}</td>
                </tr>
              ))}
            </tbody>
          </table>
